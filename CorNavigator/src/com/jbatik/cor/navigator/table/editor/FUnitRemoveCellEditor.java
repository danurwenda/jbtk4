 ...
 * @author risman
 */
public class FUnitRemoveCellEditor extends AbstractCellEditor implements TableCellEditor, ActionListener {

    private JTable jTable;
    private JButton jButton;
    private FUnitTableModel defaultTableModel;

    public FUnitRemoveCellEditor(JTable _jTable, FUnitTableModel _defaultTableModel) {
        this.jButton = new JButton();
        jTable = _jTable;
        defaultTableModel = _defaultTableModel;

        PicturePresenter.setPicture_Remove(jButton);
        jButton.addActionListener(FUnitRemoveCellEditor.this);
