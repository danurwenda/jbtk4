 ...
 * <p>Once you wrote nodes, call
 * <code>close</code> method to create the MTL file and the texture images in
 * the same directory as OBJ file. This feature applies only to constructor that
...
public class OBJWriter extends FilterWriter {
    ...
    /**
     * Create an OBJ writer for the given file, with no header and default
     * precision.
     */
     ...
     * @param header a header written as a comment at start of the OBJ file and
     * its MTL counterpart
     * @param maximumFractionDigits the maximum digits count used in fraction
     * part of numbers, or -1 for default value. Using -1 may cause writing
     * nodes to be twice faster.
     */
    ...
    /**
     * Create an OBJ writer for the given file name, with no header and default
     * precision.
     */
     ...
     *
     * @param objFileName the name of the file into which 3D nodes will be
     * written at OBJ format
     * @param header a header written as a comment at start of the OBJ file and
     * its MTL counterpart
     * @param maximumFractionDigits the maximum digits count used in fraction
     * part of numbers, or -1 for default value. Using -1 may cause writing
     ...
     * <code>out</code> stream, with no header and default precision.
     */
    ...
    /**
     * Throws an
     * <code>InterruptedRecorderException</code> exception if current thread is
     * interrupted.
     */
     ...
     * <code>node</code> at OBJ format. If there are transformation groups on
     * the path from
     * <code>node</code> to its shapes, they'll be applied to the coordinates
     * written on output. The
     * <code>node</code> shouldn't be alive or if it's alive it should have the
     * capabilities to read its children, the geometries and the appearance of
     * its shapes. Only geometries which are instances of
     * <code>GeometryArray</code> will be written.
     *
     * @param node a Java 3D node
     * @throws IOException if the operation failed
     * @throws InterruptedIOException if the current thread was interrupted
     * during this operation. The interrupted status of the current thread is
     ...
     *
     * @param node a Java 3D node
     * @param nodeName the name of the node. This is usefull to distinguish the
     * objects names in output. If this name is <code>null</code> or isn't built
    ...
    /**
     * Returns the transformation applied to a
     * <code>child</code> on the path to
     * <code>parent</code>.
     */
     ...
     * Returns
     * <code>true</code> if
     * <code>name</code> contains only letters, digits and underscores.
     */
    ...
    /**
     * Applies to
     * <code>vertex</code> the given transformation, and writes it in a line v
     * at OBJ format, if the vertex isn't a key of
     * <code>vertexIndices</code> yet.
     */
    ...
    /**
     * Applies to
     * <code>normal</code> the given transformation, and writes it in a line vn
     * at OBJ format, if the normal isn't a key of
     * <code>normalIndices</code> yet.
     */
    ...
    /**
     * Writes
     * <code>textureCoordinates</code> in a line vt at OBJ format, if the
     * texture coordinates isn't a key of
     * <code>textureCoordinatesIndices</code> yet.
     */
    ...
    /**
     * Closes this writer and writes MTL file and its texture images, if this
     * writer was created from a file.
     *
     * @throws IOException if this writer couldn't be closed or couldn't write
     * MTL and texture files couldn't be written
     * @throws InterruptedIOException if the current thread was interrupted
     * during this operation The interrupted status of the current thread is
     * cleared when this exception is thrown.
     */
    ...
    /**
     * An
     * <code>Appearance</code> wrapper able to compare if two appearances are
     * equal for MTL format.
     */
    private static class ComparableAppearance {
        ...
        /**
         * Returns
         * <code>true</code> if this appearance and the one of
         * <code>obj</code> describe the same colors, transparency and texture.
         */
        @Override
