...
public class NumericTextField extends JTextField implements
        NumericPlainDocument2.InsertErrorListener {
    ...
    public NumericTextField(String text, int columns, DecimalFormat format) {
        ...
        NumericPlainDocument2 numericDoc = (NumericPlainDocument2) getDocument();
        if (format != null) {
    ...
    public void setFormat(DecimalFormat format) {
        ((NumericPlainDocument2) getDocument()).setFormat(format);
    }

    public DecimalFormat getFormat() {
        return ((NumericPlainDocument2) getDocument()).getFormat();
    }
    ...
    public Long getLongValue() throws ParseException {
        return ((NumericPlainDocument2) getDocument()).getLongValue();
    }

    public Double getDoubleValue() throws ParseException {
        return ((NumericPlainDocument2) getDocument()).getDoubleValue();
    }

    public Number getNumberValue() throws ParseException {
        return ((NumericPlainDocument2) getDocument()).getNumberValue();
    }
    ...
    public void insertFailed(NumericPlainDocument2 doc, int offset, String str,
            AttributeSet a) {
    ...
    protected Document createDefaultModel() {
        return new NumericPlainDocument2();
    }

}

class NumericPlainDocument2 extends PlainDocument {

    public NumericPlainDocument2() {
        setFormat(null);
    }

    public NumericPlainDocument2(DecimalFormat format) {
        setFormat(format);
    }

    public NumericPlainDocument2(AbstractDocument.Content content,
    ...
    public interface InsertErrorListener {
        ...
        public abstract void insertFailed(NumericPlainDocument2 doc, int offset,
