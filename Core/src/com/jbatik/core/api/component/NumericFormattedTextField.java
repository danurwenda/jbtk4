...
/**
 * JFormattedTextField with real-time error listener.
 * @author Dimas Y. Danurwenda
 */
public class NumericFormattedTextField extends JFormattedTextField implements
    ...
    public NumericFormattedTextField(String text, int columns, DecimalFormat format) {
        super(format);
        setValue(text);
        setColumns(columns);
    ...
    public NumericFormattedTextField(int columns, DecimalFormat format) {
    ...
    public NumericFormattedTextField(String text, int columns) {
