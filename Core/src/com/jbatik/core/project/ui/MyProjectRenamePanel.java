...
import com.jbatik.core.project.ui.MyProjectOperationsImplementation.InvalidablePanel;
 ...
 * @author Jan Lahoda
 */
public class MyProjectRenamePanel extends javax.swing.JPanel implements DocumentListener, InvalidablePanel {
     ...
     */
    public MyProjectRenamePanel(ProgressHandle handle, Project project, String name) {
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(MyProjectRenamePanel.class, "LBL_Project_Name")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(projectFolderLabel, org.openide.util.NbBundle.getMessage(MyProjectRenamePanel.class, "LBL_Project_Folder")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        projectName.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(MyProjectRenamePanel.class, "ACSN_Project_Name", new Object[] {})); // NOI18N
        projectName.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(MyProjectRenamePanel.class, "ACSD_Project_Name", new Object[] {})); // NOI18N
        ...
        projectFolder.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(MyProjectRenamePanel.class, "ACSN_Project_Folder", new Object[] {})); // NOI18N
        projectFolder.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(MyProjectRenamePanel.class, "ACSD_Project_Folder", new Object[] {})); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel3, org.openide.util.NbBundle.getMessage(MyProjectRenamePanel.class, "LBL_Rename_Dialog_Text", new Object[] {ProjectUtils.getInformation(project).getDisplayName()})); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel5, org.openide.util.NbBundle.getMessage(MyProjectRenamePanel.class, "LBL_Renaming_Project", new Object[] {})); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(MyProjectRenamePanel.class, "ACSD_Project_Rename", new Object[] {})); // NOI18N
    ...
    private void validateDialog() {
        ...
        boolean changed = !currentError.equals(newError);
    ...
    private String computeError() {
        ...
        return MyProjectOperationsImplementation.computeError(location, projectName.getText(), !getRenameProjectFolder());
    }
