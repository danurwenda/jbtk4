...
/**
 * Default renderer for nodes. Can paint either Nodes directly or can be used to
 * paint objects produced by NodeTreeModel, etc.
 *
...
public class NodeRenderer extends Object implements TreeCellRenderer, ListCellRenderer {
     ...
     *
     * @deprecated This method no longer returns a shared instance, as it caused
     * problems with one view setting properties (such as enabled state) on the
     * renderer and the renderer then being used in its altered state by a
     * different view. Views should create their own instance of NodeRenderer
     * instead.
     */
     ...
     *
     * @param value value can be either <code>Node</code> or a
     * <code>VisualizerNode</code>.
    ...
    /**
     * Utility method which performs configuration which is common to all of the
     * renderer implementations - sets the icon and focus properties on the
     * renderer from the VisualizerNode.
     *
     */
    ...
    /**
     * Utility method to find a visualizer node for the object passed to any of
     * the cell renderer methods as the value
     */
     ...
     *
     * @param dragged the value of cell which should have 'drag under' visual
     * feedback
     */
