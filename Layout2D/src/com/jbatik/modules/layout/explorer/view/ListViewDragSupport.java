...
class ListViewDragSupport extends ExplorerDragSupport {
    ...
    /**
     * Holds selected indices - it's here only as a workaround for sun's bug
     */
    ...
    /**
     * Utility method. Returns either selected nodes in the list (if cursor
     * hotspot is above some selected node) or the node the cursor points to.
     *
