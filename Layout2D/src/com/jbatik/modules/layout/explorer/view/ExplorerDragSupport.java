...
abstract class ExplorerDragSupport implements DragSourceListener, DragGestureListener {
    ...
    /**
     * Utility method. Returns either selected nodes in tree (if cursor hotspot
     * is above some selected node) or the node the cursor points to.
     *
     * @return Node array or null if position of the cursor points to no node.
     */
