...
import static com.jbatik.modules.layout.explorer.view.Bundle.*;
...
public final class ExplorerActionsImpl {
    ...
    private class DeleteActionPerformer extends BaseAction implements Runnable {
        ...
        @NbBundle.Messages({
            "# {0} - name",
            "MSG.ConfirmDeleteObject=Are you sure you want to delete {0}?",
            "MSG.ConfirmDeleteObjectTitle=Confirm Object Deletion",
            "# {0} - number of objects",
            "MSG.ConfirmDeleteObjects=Are you sure you want to delete these {0} items?",
            "MSG.ConfirmDeleteObjectsTitle=Confirm Multiple Object Deletion"
        })
    ...
    /**
     * Class which register changes in manager, and clipboard, coalesces them if
     * they are frequent and performs the update of actions state.
     */
