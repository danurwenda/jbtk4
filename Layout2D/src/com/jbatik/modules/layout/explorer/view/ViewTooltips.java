 ...
 * space. This class is not NB specific, and can be used with any JTree or
 * JList.
 *
 * @author Tim Boudreau
 */
final class ViewTooltips extends MouseAdapter implements MouseMotionListener {
    ...
    /**
     * Register a child of a JScrollPane (only JList or JTree supported for now)
     * which should show helper tooltips. Should be called from the component's
     * addNotify() method.
     */
    ...
    /**
     * Unregister a child of a JScrollPane (only JList or JTree supported for
     * now) which should show helper tooltips. Should be called from the
     * component's removeNotify() method.
     */
    ...
    /**
     * Shows the appropriate popups given the state of the scroll pane and its
     * view.
     *
    ...
    /**
     * Set the currently shown component and row, returning true if they are not
     * the same as the last known values.
     */
    ...
    /**
     * Hide all popups and discard any references to the components the popups
     * were showing for.
     */
    void hide() {
        ensureOldPopupsHidden();
    ...
    /**
     * Gets the sub-rectangle of a JScrollPane's area that is actually showing
     * the view
     */
    ...
    /**
     * Fetches an array or rectangles representing the non-overlapping portions
     * of a cell rect against the visible portion of the component.
     *
     * @bds The cell's bounds, in the coordinate space of the tree or list
     * @vis The visible area of the tree or list, in the tree or list's
     * coordinate space
     */
    ...
    /**
     * Set a component (JList or JTree) which should be listened to, such that
     * if a model, selection or scroll event occurs, all currently open popups
     * should be hidden.
     */
    ...
    private static final class ImgComp extends JComponent {
        ...
        /**
         * Configures a tree cell renderer and sets up sizing and the backing
         * image from it
         */
        ...
        /**
         * Configures a list cell renderer and sets up sizing and the backing
         * image from it
         */
