...
/**
 * List of Visualizers. This is holded by parent visualizer by a weak reference,
 * 
...
final class VisualizerChildren extends Object {
    ...
    /**
     * visualizer nodes (children), access only from AWT dispatch thread via the
     * getVisNodes() getter
     */
    ...
    /**
     * Creates new VisualizerChildren. Can be called only from EventQueue.
     */
