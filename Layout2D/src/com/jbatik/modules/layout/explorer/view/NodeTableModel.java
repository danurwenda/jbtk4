...
public class NodeTableModel extends AbstractTableModel {
     ...
     *
     * @param Index to the array of all properties (the column may not be
     * visible)
     */
     ...
     *
     * @param Index to the array of all properties (the column may not by
     * visible)
     */
    ...
    /**
     * Helper method to ask if column representing a property should be visible
     */
