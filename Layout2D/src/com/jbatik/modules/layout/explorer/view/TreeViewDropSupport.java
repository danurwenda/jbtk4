...
final class TreeViewDropSupport implements DropTargetListener, Runnable {
    ...
    /**
     * @return The tree path to the node the cursor is above now or null if no
     * such node currently exists or if conditions were not satisfied to
     * continue with DnD operation.
     */
    ...
    /**
     * Safe accessor to the drop target which is asociated with the tree
     */
