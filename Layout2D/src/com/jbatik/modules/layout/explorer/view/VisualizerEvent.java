...
/**
 * Event describing change in a visualizer. Runnable to be added into the event
 * queue.
 * 
...
abstract class VisualizerEvent extends EventObject {
    ...
    /**
     * Class for notification of adding of nodes that can be passed into the
     * event queue and in such case notifies all listeners in Swing Dispatch
     * Thread
     */
    ...
    /**
     * Class for notification of removing of nodes that can be passed into the
     * event queue and in such case notifies all listeners in Swing Dispatch
     * Thread
     */
    static final class Removed extends VisualizerEvent implements Runnable {
        ...
        /**
         * linked list of removed nodes, that is filled in getChildren
         * ().removed () method
         */
    ...
    /**
     * Class for notification of reordering of nodes that can be passed into the
     * event queue and in such case notifies all listeners in Swing Dispatch
     * Thread
     */
