...
/**
 * Allows customization of the popup menus of TableView and OutlineView. Just
 * create a subclass of this class and override method createPopupMenu (and call
 * setNodePopupFactory() on TableView or OutlineView).
 *
 * @author David Strupl
 */
public class NodePopupFactory {
    ...
    /**
     * Creates a popup menu with entries from the selected nodes related to the
     * given component (usually a ETable subclass). The popup is created for the
     * table element in given column and row (column and row are in the view's
     * coordinates (not the model's)).
     */
