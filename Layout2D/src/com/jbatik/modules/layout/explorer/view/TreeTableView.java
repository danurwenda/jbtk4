...
import com.jbatik.modules.layout.explorer.view.TreeView.PopupAdapter;
import com.jbatik.modules.layout.explorer.view.TreeView.PopupSupport;
import com.jbatik.modules.layout.explorer.view.TreeView.TreePropertyListener;
 ...
 * Pass this method an array of properties. These will act as a template, and
 * properties of the displayed nodes which share the same <i>name</i> will be
 * used in the columns of the table.
 *
 * You can customize behaviour of property columns using <code>Property.setValue (String parameter,
 * Object value)</code>. For example, assume you have following array of
 * properties:
 ...
 * <TD> Boolean </TD>
 * <TD> If this parameter and <code>SortingColumnTTV</code> is set,
 * TreeTableView should be initially sorted by this property columns in
 * descending order.
 * </TD>
 * </TR>
 * <TR>
 ...
 * displayed as Nth column of table. If not set, column will be displayed in
 * natural order.
 * </TD>
 * </TR>
 * <TR>
 * <TD> TreeColumnTTV</TD>
 * <TD> Boolean </TD>
 * <TD> Identifies special property representing first (tree) column. To allow
 * setting of
 * <code>SortingColumnTTV, DescendingOrderTTV, ComparableColumnTTV</code>
 * parameters also for first (tree) column, use this special parameter and add
 ...
 * display name (e.g. in <I>Change Visible Columns</I> dialog window). If not
 * set, no mnemonic will be displayed.
 * </TD>
 * </TR>
 * <TR>
 * <TD> ColumnDisplayNameWithMnemonicTTV</TD>
 * <TD> String </TD>
 * <TD> When set, this parameter contains column's display name with '&amp;' as
 * the mnemonic. This parameter should be preferred over ColumnMnemonicCharTTV.
 * </TD>
 * </TR>
 * </TABLE>
 *
...
public class TreeTableView extends BeanTreeView {
    ...
    /**
     * Accessible context of this class (implemented by inner class
    ...
    /**
     * Do not initialize tree now. We will do it from our constructor. [dafe]
     * Used probably because this method is called *before* superclass is fully
     * created (constructor finished) which is horrible but I don't have enough
     * knowledge about this code to change it.
     */
    @Override
    void initializeTree() {
    }
    ...
    /**
     * Overrides JScrollPane's getAccessibleContext() method to use internal
     * accessible context.
     */
    @Override
    ...
    /**
     * This is internal accessible context for TreeTableView. It delegates
     * setAccessibleName and setAccessibleDescription methods to set these
     * properties in underlying TreeTable as well.
     */
    ...
    private final class ScrollListener extends ComponentAdapter implements PropertyChangeListener, ChangeListener {
        ...
        private void revalidateScrollBar() {
            ...
            if ((treeTable.getColumnModel().getColumnCount() > 0)
    ...
    /**
     * Scrollable (better say not scrollable) pane. Used as container for left
     * (controlling) and rigth (controlled) scroll panes.
     */
