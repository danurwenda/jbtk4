...
/**
 * The support for autoscrolling in components contained in the viewport.
 * 
* @author Dafe Simonek
 */
final class AutoscrollSupport extends Object implements Autoscroll {
    ...
    /**
     * Insets to return from getAutoscrollInsets - insets where autoscroll could
     * potencionally occur
     */
    Insets autoscrollInsets;

    /**
     * Creates a support for given component with given insets where
    ...
    /**
     * Sets autoscroll scroll units. When autoscroll(..) method is called, it
     * will scroll the component accordign to scroll unit in appropriate
     * direction. So, scrollUnits.top says how much (in pixels) the component
    ...
    /**
     * Getter for viewport of asociated component. Can return null if component
