...
class TableSheet extends JScrollPane {
    ...
    static class ControlledTableView extends TableSheet {
        ...
        private class ATable extends JTable {
            ...
            /**
             * Try to revalidate once again because we want table to have width
             * that it asked for.
             */
    ...
    /**
     * Makes visible horizontal scroll bar of dependent scrollpane.
     * Enables/disables horizontal scrollbar of parent scrollpane.
     */
