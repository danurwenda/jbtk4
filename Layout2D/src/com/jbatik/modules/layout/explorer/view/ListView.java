 ...
 * {@link org.openide.explorer.ExplorerUtils}. Then just use
 ...
 * {@link javax.swing.JMenu} structure based on structure of {@link Node}s</li>
 * </ul>
 * <p>
 * All of these views use {@link ExplorerManager#find} to walk up the AWT
 * hierarchy and locate the {@link ExplorerManager} to use as a controller. They
 * attach as listeners to it and also call its setter methods to update the
 * shared state based on the user action. Not all views make sense together, but
...
public class ListView extends JScrollPane implements Externalizable {
    ...
    //
    /**
     * if true, the icon view displays a popup on right mouse click, if false,
    ...
    /**
     * Enable/disable displaying popup menus on list view items. Default is
     * enabled.
     *
    ...
    /**
     * Enable/disable hierarchy traversal using <code>CTRL+click</code> (down)
     * and <code>Backspace</code> (up), default is enabled.
     *
     * @param value <code>true</code> to enable
     */
    ...
    /**
     * Shall the first node in the list be ".." representing currently explored
     * context? By default it is not, but if you want to simplify the navigation
     * in the {@link  Node} hierarchy, you can turn this property on.
     *
    ...
    /**
     * Get the current processor for default actions. If not <code>null</code>,
     * double-clicks or pressing Enter on items in the view will not perform the
     * default action on the selected node; rather the processor will be
     ...
     *
     * @param value the new default-action processor, or <code>null</code> to
     * restore use of the selected node's declared default action
     ...
     *
     * @param selectionMode one of
     * {@link ListSelectionModel#SINGLE_SELECTION}, {@link ListSelectionModel#SINGLE_INTERVAL_SELECTION},
     ...
     */
    /**
     * @return true if dragging from the view is enabled, false otherwise.<br>
    ...
    /**
     * This method is called when user double-clicks on some object or presses
     * Enter key.
     *
    ...
    // innerclasses .........................................................................
    /**
     * Enhancement of standard JList. Provides access to the Node's ToolTips,
     * Accessibility and Autoscrolling.
     */
    final class NbList extends JList implements Autoscroll {
        ...
        // ToolTips:
        /**
         * Overrides JComponent's getToolTipText method in order to allow Node's
         * tips to be used if they are useful.
         *
        ...
        private List<Integer> doSearch(String prefix) {
            ...
            if (size == 0) {
                return results; // nothing to search
            }
            while (true) {
