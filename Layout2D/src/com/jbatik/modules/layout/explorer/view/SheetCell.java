...
abstract class SheetCell extends AbstractCellEditor implements TableModelListener, PropertyChangeListener, TableCellEditor, TableCellRenderer {
     ...
     *
     * @param f <code>true</code> means flat, <code>false</code> means with
     * button border
     */
    ...
    /**
     * Two-tier cache for property panels Map<TreeNode,
     * WeakHashMap<Node.Property, Reference<FocusedPropertyPanel>>
     */
    ...
    public static class OutlineSheetCell extends SheetCell {
        ...
        public OutlineSheetCell(PhotoshopOutline outline) {
        ...
        private boolean stopCellEditingNoCommit() {
            ...
            if (outline instanceof PhotoshopOutlineView.OutlineViewOutline) {
                PhotoshopOutlineView.OutlineViewOutline ovo = (PhotoshopOutlineView.OutlineViewOutline) outline;
                prm = ovo.getRowModel();
            }
            if (prm != null) {
