...
public class NodeTreeModel extends DefaultTreeModel {
     ...
     * node changed. If you use custom user objects in the TreeModel
     * you'returngoing to need to subclass this and set the user object of the
    ...
    private static final class Listener implements NodeModel {
        ...
        /**
         * Notification of children addded event. Modifies the list of nodes and
         * fires info to all listeners.
         */
        @Override
        ...
        /**
         * Notification that children has been removed. Modifies the list of
         * nodes and fires info to all listeners.
         */
        @Override
        ...
        /**
         * Notification that children has been reordered. Modifies the list of
         * nodes and fires info to all listeners.
         */
        @Override
