...
class PropertiesRowModel implements RowModel {
    ...
    private static class OutlineTooltipUpdater implements MouseMotionListener, MouseListener {
        ...
        public void fireToolTipChanged(final PhotoshopOutline outline, final int row) {
            SwingUtilities.invokeLater(new Runnable() {
                @Override
                public void run() {
    ...
    public void setOutline(PhotoshopOutline outline) {
    ...
    /**
     * Processes <code>Throwable</code> thrown from <code>setAsText</code> or
     * <code>setValue</code> call on <code>editor</code>. Helper method. Almost
     * copied from PropUtils
     */
    ...
    /**
     * Of the parameter is of type Node.Property this methods calls getValue on
     * the property and returns the value. If the parameter is something else
    ...
    /**
     * Search the properties for given property name. The returned value is the
     * index of property: you have to add 1 to make it the column index because
     * the column with index 0 is reserved for the tree!
     */
