...
class TreeTable extends JTable implements Runnable {
    ...
    /**
     * Overridden - JTable's implementation of the method will actually attach
     * (and leave behind) a gratuitous border on the enclosing scroll pane.
     */
    @Override
    ...
    /**
     * #53748: Default TableHeader provides wrong preferred height when the
     * first column uses default renderer and has no value.
     */
    ...
    class TreeTableCellRenderer extends JTree implements TableCellRenderer {
        ...
        /**
         * Overridden to always set the size to the height of the TreeTable and
         * the width of column 0. The paint() method will translate the
         * coordinates to the correct position. Fire width property change so
         * that we can revalidate horizontal scrollbar in TreeTableView.
         */
        @Override
    ...
    class TreeTableCellEditor extends DefaultCellEditor implements TreeSelectionListener, ActionListener, FocusListener,
        ...
        /**
         * This is overridden to forward the event to the tree and start editor
         * timer.
         */
        @Override
    ...
    /**
     * #63287 - in JDK1.6 the JTable makes additional changes to the
     * ListSelectionModel when clearing row selection. These events must be
     * ignored the same way as the overridden method TreeTable.clearSelection()
     */
    ...
    /**
     * Focus transfer policy that retains focus after closing an editor. Copied
     * wholesale from org.openide.explorer.propertysheet.SheetTable
     */
    ...
    /**
     * Enables tab keys to navigate between rows but also exit the table to the
     * next focusable component in either direction
     */
