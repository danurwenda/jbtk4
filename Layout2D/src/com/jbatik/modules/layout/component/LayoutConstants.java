...
public interface LayoutConstants {
    ...
    // size constants
    /**
     * Indicates a size or position not defined in the layout model; it must be
     * obtained elsewhere (e.g. from a real component).
     */
    int NOT_EXPLICITLY_DEFINED = -1;

    /**
     * Specifies that a min or max size value should be the same as the
    ...
    enum PaddingType {
        ...
        RELATED, UNRELATED, INDENT, SEPARATE
    }
